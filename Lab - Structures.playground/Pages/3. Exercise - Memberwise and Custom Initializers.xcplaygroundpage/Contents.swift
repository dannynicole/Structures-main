...
init(heightInInches2: Double){
    heightInInches = heightInInches2
    heightInCentimeters = 2.54 * heightInInches
    }


init(heightInCentimeters2: Double){
    heightInInches = heightInCentimeters2
    heightInCentimeters = heightInCentimeters2
}

}
var h = Height(heightInCentimeters2: 165.1)
