 ...
 */
var dana = user(name: "Dana", age: 17, height:5.2, weight:120, activityLevel:3)

print("My name is \(dana.name), age\(dana.age), weight \(dana.weight), height \(dana.height), activityLevel \(dana.activityLevel) ")
/*:
